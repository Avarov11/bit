  ...
  if (!product) {
    return (
      <main className="min-h-screen pt-20 flex flex-col items-center justify-center px-4 text-center" style={{ backgroundColor: "#F5D0D8" }}>
        <p className="font-playfair text-2xl font-bold text-[#2D000A] mb-3">Product not found</p>
        <Link href="/menu" className="text-[#800020] font-semibold hover:underline">Back to Menu</Link>
      </main>
    );
  }
