...
const en: Record<string, string> = {
  ...
  checkout_area_label: "Delivery Area",
  checkout_area_placeholder: "Select your area",
  checkout_error_area: "Please select a delivery area",
  checkout_address_label: "Building / Street Details",
  checkout_address_placeholder: "Building name/number, floor, apartment, landmarks…",
  ...
  checkout_error_address: "Please enter your building / street details",
...
const ar: Record<string, string> = {
  ...
  checkout_area_label: "منطقة التوصيل",
  checkout_area_placeholder: "اختر منطقتك",
  checkout_error_area: "الرجاء اختيار منطقة التوصيل",
  checkout_address_label: "تفاصيل المبنى والشارع",
  checkout_address_placeholder: "اسم المبنى أو رقمه، الطابق، رقم الشقة، معالم قريبة…",
  ...
  checkout_error_address: "الرجاء إدخال تفاصيل المبنى والشارع",
